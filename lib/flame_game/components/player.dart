...
import 'package:ranger_gabo/flame_game/components/obstacles.dart';
import 'package:ranger_gabo/flame_game/effects/hurt_effect.dart';
import 'package:ranger_gabo/flame_game/effects/jump_effect.dart';
  ...
  Future<void> onLoad() async {
    ...
    animations = {
      PlayerState.running: await game.loadSpriteAnimation(
        'player/walk_robot.png',
        SpriteAnimationData.sequenced(
          amount: 6,
          stepTime: 0.15,
          textureSize: Vector2(177,235),
        ),
      ),
      PlayerState.jumping: SpriteAnimation.spriteList(
        // dash/dash_jumping.png 
        [await game.loadSprite('player/jump_robot.png')],
        stepTime: double.infinity,
      ),
      PlayerState.falling: SpriteAnimation.spriteList(
        [await game.loadSprite('player/character_robot_idle.png')],
        stepTime: double.infinity,
      ),
    };
