...
import 'package:ranger_gabo/settings/persistence/local_storage_settings_persistence.dart';

import 'package:ranger_gabo/settings/persistence/settings_persistence.dart';
  ...
  Future<void> _loadStateFromPersistence() async {
    final loadedValues =  await Future.wait([
      ...
      _store
        ...
        .then((value) => soundsOn.value = value),
      _store
        .getPlayerName().then((value) => playerName.value = value),
    ]);
