...
import 'package:ranger_gabo/player_progress/player_progress.dart';
import 'package:ranger_gabo/router.dart';
...
Future<void> main() async {
  ...
  runApp(const RangerGame());
}

class RangerGame extends StatelessWidget {
  const RangerGame({super.key});
